...
var ReactGuides = require('croact-guides');
...
var PROPERTIES = ReactGuides.PROPERTIES;
var METHODS = ReactGuides.METHODS;
var EVENTS = ReactGuides.EVENTS;
...
function (_super) {
  ...
  __proto.render = function () {
    return React.createElement(ReactGuides, __assign({
...
function (_super) {
  ...
  function Guides(container, options) {
    ...
    _this.containerProvider = React.renderSelf(React.createElement(InnerGuides, __assign({
      ref: frameworkUtils.ref(_this, "innerGuides")
