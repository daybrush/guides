...
(function (global, factory) {
      ...
      function Gesto(targets, options) {
        ...
        _this.onDragStart = function (e, isTrusted) {
          ...
          if (isDragStart) {
            ...
            var result = _this._preventMouseEvent || _this.emit("dragStart", __assign$4(__assign$4({
              data: _this.data,
              datas: _this.data,
              inputEvent: e,
        ...
        _this.onDrag = function (e, isScroll) {
          ...
          if (_this._dragFlag) {
            if (_this.pinchFlag || result.deltaX || result.deltaY) {
              var dragResult = _this._preventMouseEvent || _this.emit("drag", __assign$4(__assign$4({}, result), {
                isScroll: !!isScroll,
                inputEvent: e
              }));
        ...
        _this.onDragEnd = function (e) {
          ...
          if (!_this.flag) {
            ...
            _this._preventMouseEvent || _this.emit("dragEnd", __assign$4({
              data: _this.data,
              datas: _this.data,
              isDouble: isDouble,
              isDrag: isDrag,
    ...
    ***************************************************************************** */
    ...
    function prefix() {
      ...
      return prefixNames.apply(void 0, __spreadArray(["scena-"], classNames, false));
    }
    ...
    var PROPERTIES$1 = __spreadArray(["className", "rulerStyle", 'snapThreshold', "snaps", "displayDragPos", "cspNonce", 'dragPosFormat', "defaultGuides", "showGuides"], PROPERTIES, true);

    var METHODS = ["getGuides", "loadGuides", "scroll", "scrollGuides", "resize", "forceUpdate"];
    ...
    var Guides = /*#__PURE__*/function (_super) {
          ...
          return guides.map(function (pos, i) {
            return createElement("div", {
              ...
              style: __assign$6(__assign$6({}, guideStyle), {
                transform: "".concat(translateName, "(").concat(pos * zoom, "px) translateZ(0px)")
              })
      ...
      __proto.scrollGuides = function (pos, nextZoom) {
        ...
        this.scrollPos = pos;
        guidesElement.style.transform = "".concat(this.getTranslateName(), "(").concat(-pos * nextZoom, "px)");
        var guides = this.state.guides;
      ...
      __proto.movePos = function (e) {
        ...
        if (!datas.fromRuler || !this._isFirstMove) {
          ...
          target.style.transform = "".concat(this.getTranslateName(), "(").concat(nextPos, "px)");
        }
